public class LinkedListDeque<T> {
	...
	public T removeLast(){
		if(totalSize == 0)
			return null;
		totalSize--;
		T item = sentinel.prev.prev.item;
...
//		LinkedListDeque<Integer> linkedList = new LinkedListDeque<Integer>();
...
//		System.out.println(linkedList.getRecursive(2));
//		linkedList.printDeque();
